 ...
 * BETA FUNCTIONS
 */exports.updateClipboard=updateClipboard,Node.prototype.on=function(a){var b=this;const c=a.startsWith("on"),d=void 0===this[a];if(a=!1==c?`on${a}`:a,!1==d)throw new Error(`This type of event (${a}) doesn\'t exist`);return function(c){return b[a]=c}};