...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.connection=exports.fieldTypes=exports.returnTag=exports.returnNode=exports.LocalDB=exports.Api=exports.fetchAPI=exports.cookies=exports.getFormData=exports.eventCallback=exports.Element=exports.node=void 0;/**
...
const b=new Set,c=new FormData(a),d=new Map,e=a.querySelectorAll("[name]");return e.forEach(function(a){b.add({name:a.getAttribute("name"),type:a.getAttribute("type")||"textarea"})}),b.forEach(function(a){d.set(a.name,"number"==a.type?parseFloat(c.get(a.name)):c.get(a.name))}),d};/**
 ...
 */exports.LocalDB=LocalDB;const returnNode=function(a,b=!1){if("node"==typeof a)return a;if("string"==typeof a){const c=document.querySelectorAll(a);return!1==b?c[0]:c}};/**
